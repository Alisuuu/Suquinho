...
App.UI.state = {
    ...
    currentEpisodeEmbedderUrl: '', // Garante que esta variável esteja inicializada
...
// pois `fetchItemDetails` está em `script4.js`
...
App.UI.embedderPlugin = (type, imdb, season, episode, targetContainerId = 'EmbedderIframeContainer') => {
    ...
    else if (targetContainerId === 'EpisodeEmbedderIframeContainer') App.UI.state.currentEpisodeEmbedderUrl = embedUrl; // Esta linha define a URL do episódio
