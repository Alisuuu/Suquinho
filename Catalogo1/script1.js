...
// --- State Variables ---
let currentFilterTypeSA = 'movie'; // Tipo de filtro selecionado no SweetAlert (filme ou série)
...
let currentContentContext = 'main'; // Contexto atual do conteúdo: 'main', 'search', ou 'filter'
